    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="text-center py-8">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No CVEs</h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">CVE list will be displayed here when available.</p>
        </div>
      </div>
    </div>
  );
